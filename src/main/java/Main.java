...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean nextCustomer = Boolean.TRUE;
        // No es necesario agregar multiples clientes ya que el caso de uso es registro de un usuario asociado a un carrito
        // de compra
        while (nextCustomer) {
            ...
            System.out.println("Desea Agregar otro cliente? Y/n");
            nextCustomer = scan.nextLine().equals("Y");
        }
    }
}
